...
traindir = 'dataset/merger/noninteracting/training'
valdir = 'dataset/merger/noninteracting/validation'
testdir = 'dataset/merger/noninteracting/test'
...
X_train = np.concatenate(
    [
        read_images(
            'dataset/merger/noninteracting/training', resolution=(64, 64)),
        # read_images(
...
X_val = np.concatenate(
    [
        read_images(
            'dataset/merger/noninteracting/validation', resolution=(64, 64)),
        # read_images(
...
X_test = np.concatenate(
    [
        read_images(
            'dataset/merger/noninteracting/test', resolution=(64, 64)),
        # read_images(
